...
export const GEMATRIAS: Gematria[] = [
  ...
  {
    num: 137, he: "קַבָּלָה", titulo: "Kabalah", tituloFa: "قبالا",
    sig: "Kabalah («recibir») = 137 — un número que Rav Ginsburgh estudia extensamente.",
    sigFa: "قبالا («دریافت») = ۱۳۷ — عددی که راو گینزبورگ بسیار مطالعه می‌کند.",
    asociaciones: ["קַבָּלָה (Kabalah) = 137", "אָזְנַיִם (oídos, «recibir») resonancias", "Estudiado por Ginsburgh"],
    asociacionesFa: ["قبالا = ۱۳۷", "پژواک‌های «دریافت»", "موردِ مطالعهٔ گینزبورگ"],
    color: "#9a6a8e",
  },
  {
