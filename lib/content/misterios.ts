...
export const MISTERIOS: Misterio[] = [
  ...
  // "próximamente" hasta que el Sofer los escriba). Slugs según 00-MAPA-SERIE.md.
  {
    ...
    gancho: "No es el mesías cristiano ni «otra religión». ¿Persona, conciencia colectiva o estado de conciencia? El Mashíaj es las tres — y casi nadie lo sabe. La puerta de la serie sobre el fin de los días.",
    ganchoFa: "نه مسیحِ مسیحیان است و نه «دینی دیگر». شخص، آگاهیِ جمعی یا حالتِ آگاهی؟ ماشیح هر سه است — و کمتر کسی این را می‌داند. دروازهٔ سری دربارهٔ آخریتِ روزها.",
    serie: "mashiaj",
    color: "#c9a43e",
    orden: 0,
  },
