...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 12 — עוֹלָם הַבָּא וְהַתַּכְלִית · Olam HaBa y la Consumación Final
//  Bloque III (Interior y Consumación) · CIERRE DE LA SERIE. Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-12-olam-haba.md
//  Hero: מָשִׁיחַ (Mashíaj) = נָחָשׁ (Najash) = 358 — cierra el círculo del Estudio 0.
//  El umbral הֶמְשֵׁךְ vuelve a {{study:enigma-mashiaj}} (cierra el arco).
...
export const data: EstudioData = {
  slug: "olam-haba",
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 12 — Interior y Consumación · Cierre",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۱۲ — درون و کمال · پایان",
    he: "עוֹלָם הַבָּא וְהַתַּכְלִית",
    titulo: "Olam HaBa y la Consumación Final",
    tituloFa: "عولام هَبا و غایتِ نهایی",
    ganchoEs:
      "Toda la serie empezó con un enigma —«¿qué es el Mashíaj?»— y termina con cinco palabras de Zejaryá: «YHVH Uno, Su Nombre Uno». El Mashíaj nunca fue una persona que llega. Es el mundo volviéndose Uno.",
    ganchoFa:
      "تمامِ سری با معمایی آغاز شد —«ماشیح چیست؟»— و با پنج واژهٔ زخریا پایان می‌یابد: «خداوند یکی، نامش یکی». ماشیح هرگز شخصی نبود که می‌آید. جهان است که یکی می‌شود.",
    par: {
      a: { he: "מָשִׁיחַ", rom: "Mashíaj", color: "gold" },
      b: { he: "נָחָשׁ", rom: "Najash · la serpiente", color: "red" },
      valor: "358",
    },
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla I — Zejaryá (Zacarías) 14:9",
        he: "וְהָיָ֧ה יְהֹוָ֛ה לְמֶ֖לֶךְ עַל־כׇּל־הָאָ֑רֶץ בַּיּ֣וֹם הַה֗וּא יִהְיֶ֧ה יְהֹוָ֛ה אֶחָ֖ד וּשְׁמ֥וֹ אֶחָֽד׃",
        es: "Y será YHVH rey sobre toda la tierra; en aquel día YHVH será Uno y Su Nombre Uno (YHVH Ejad u-Shmó Ejad).",
        source: "Zejaryá (Zacarías) 14:9",
      },
      {
        label: "Versículo-ancla II — Daniel 12:2",
        he: "וְרַבִּ֕ים מִיְּשֵׁנֵ֥י אַדְמַת־עָפָ֖ר יָקִ֑יצוּ אֵ֚לֶּה לְחַיֵּ֣י עוֹלָ֔ם וְאֵ֥לֶּה לַחֲרָפ֖וֹת לְדִרְא֥וֹן עוֹלָֽם׃",
        es: "Y muchos de los que duermen en el polvo de la tierra despertarán: estos para vida eterna (jayei olam), y aquellos para vergüenza y horror eterno.",
        source: "Daniel 12:2",
      },
    ],
    parrafos: [
