...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 0d — הַזֶּרַע הַמְּשִׁיחִי · La Simiente Mesiánica
//  Estudio conceptual independiente de la Puerta. Se suma a la tríada
//  (enigma-mashiaj · despertar-de-lo-alto · tercer-templo) y va ANTES de los
//  doce módulos. Sigue un solo hilo concreto —la zéra (זֶרַע)— desde el Edén
//  hasta el Mashíaj, en clave de genealogía: el birur de las chispas contado
//  como un linaje. Serie "Del Enigma del Mashíaj al Ajarít HaYamim".
//
//  Hero CONCEPTUAL (sin gematría): la simiente que atraviesa la historia, el
//  zéra que se decanta y se abre paso por caminos improbables hasta el rey que
//  repara la fractura primordial. Fuente verificada por el Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/00d-simiente-mesianica.md
//
//  Montado con el componente compartido EstudioMisterio. El material "PARA REDES"
//  y la "Nota del Sofer" del .md son internos y NO se montan. El voseo de Maasé
//  está en neutro. Cero menciones cristianas: todo es Tanaj, Targum, Midrash,
//  comentaristas clásicos, Arizal y jasidut.
//
...
const data: EstudioData = {
  ...
  hero: {
    serielabel:
      "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 0d — La Puerta · Estudio conceptual independiente",
    serielabelFa:
      "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۰د — دروازه · مطالعهٔ مفهومیِ مستقل",
    ...
    ganchoFa:
      "بذری هست —یک زِرَع— که گویی با ارادهٔ خود از سراسرِ تاریخ می‌گذرد: رشته‌ای باریک از نسل که از هر کوششی برای بریدنش جان به‌در می‌برد، از ناممکن‌ترین راه‌ها می‌گذرد، و سنت آن را با ماشیح یکی می‌داند. میدراش آن را «بذری که از جای دیگر می‌آید» می‌نامد. این مطالعه آن رشته را از عدن تا پادشاهی که شکافِ آغازین را ترمیم می‌کند دنبال می‌کند.",
  },
  targum: {
    citas: [
      {
        ...
        es: "Y pondré enemistad entre ti y la mujer, y entre tu simiente (zar'ajá) y su simiente (zar'áh); ella te golpeará la cabeza, y tú le golpearás el talón.",
        source: "Bereshit (Génesis) 3:15",
      },
      {
        label: "Versículo-ancla II — Bereshit (Génesis) 21:12 (la simiente se decanta: por Yitzjak)",
        he: "וַיֹּ֨אמֶר אֱלֹהִ֜ים אֶל־אַבְרָהָ֗ם … כֹּל֩ אֲשֶׁ֨ר תֹּאמַ֥ר אֵלֶ֛יךָ שָׂרָ֖ה שְׁמַ֣ע בְּקֹלָ֑הּ כִּ֣י בְיִצְחָ֔ק יִקָּרֵ֥א לְךָ֖ זָֽרַע׃",
        es: "Y dijo Elohim a Avraham: … todo lo que te diga Sará, escucha su voz, porque por Yitzjak será llamada tu simiente (ki ve-Yitzjak yikaré lejá zára).",
        source: "Bereshit (Génesis) 21:12",
      },
    ],
    parrafos: [
  ...
  hitbonenut: {
    ...
    parrafos: [
      ...
      },
      {
        ...
        texto: `Veo el patrón del tamizado: la perla está en el polvo, y hay que cribar montón tras montón hasta hallarla. Veo el patrón de la brecha (Péretz): la simiente no se cuela suave, irrumpe rompiendo. Y veo el patrón de la selección: el hilo se afina generación tras generación —por Yitzjak, no por todos; por Yaakov, no por Esav— como un metal que se purifica al fuego. Dispersión y recolección, otra vez: las chispas caen, y la simiente las va recogiendo. Es el mismo birur de toda la serie, contado ahora como una historia de familia.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con mi alma?",
        texto: `Si soy una de las chispas de esa simiente —si lo más profundo de mí, mi {{letter:yud|Yejidá}}, nunca se separó de su fuente—, entonces mi vida también es un eslabón del hilo, y mi «capítulo incómodo» —ese que quisiera saltarme— puede ser justo el lugar donde cayó mi perla. La chispa que me toca elevar no está en la vida que envidio, sino en la que me tocó. La simiente mesiánica no me pide ser perfecto: me pide abrirme paso, como Péretz, desde donde estoy.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con la creación?",
        texto: `Toda la creación es esta simiente a gran escala: una luz de «otro lugar» plantada en el mundo, que se abre camino entre las cáscaras, vida tras vida, hasta dar su fruto. La fractura del Edén —la cabeza de la serpiente— no se repara de un golpe, sino por el lento crecimiento de un grano que Dios sembró al principio y que culmina al final. La historia es el tiempo que tarda esa semilla en madurar.`,
      },
    ],
  },
  maase: {
  ...
  jatima: {
    items: [
      ...
      {
        etiqueta: "Insight clave (la dirección del hilo):",
        texto: `La simiente no avanza por la avenida obvia, sino por la brecha (Péretz, «el que rompe», 38:29) y por lo «manchado» o «extranjero», a propósito: ahí cayeron las chispas que debía recoger. El Midrash lo sella con la parábola de la perla (Rut Rabbá 8:1): Dios tamiza las generaciones —montón tras montón de polvo— hasta hallar a David. «Antes de que naciera el primer opresor, ya había nacido el redentor final»; «Dios estaba creando la luz del rey Mashíaj» mientras la historia parecía deshacerse (Bereshit Rabbá 85:1).`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `La simiente mesiánica es it'aruta dile'eila en forma de semilla: un orden «de otro lugar» (la luz que no se gana) que desciende y luego se abre paso desde abajo a través de los gilgulim y el birur de las chispas (conexión con el {{study:shaar-hagilgulim|Estudio 10}} y con la tríada de la Puerta). El día en que ese grano da su fruto pleno —«machacada la cabeza» de la serpiente (3:15; Ramban), sanada la fractura— es, en el Targum, bimei malka Meshijá: los días del Rey Mashíaj.`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Tomar hoy un «capítulo incómodo» de tu vida —el que sueles saltarte—, mirarlo de frente y «abrir una brecha» (péretz) con un acto concreto de reparación, sabiendo que la perla suele estar escondida justo en el polvo que descartamos.`,
      },
    ],
  },
  hemshej: [
    "{{study:shaar-hagilgulim|Si la simiente recoge chispas a través de las generaciones, ¿cómo se recogen las chispas de una sola alma a través de muchas vidas? El Shaar HaGilgulim: el alma de Adam fragmentada y su recolección por los gilgulim.}}",
    "{{study:despertar-de-lo-alto|La simiente «de otro lugar» baja antes de subir. ¿Y si todo el hilo empezó con un descenso —una luz que no se gana, que Dios sembró primero? El despertar desde arriba.}}",
    "{{study:enigma-mashiaj|Si la simiente culmina en el Mashíaj, ¿qué es realmente ese Mashíaj? Persona, conciencia colectiva y estado de conciencia, a la vez. El enigma de la Puerta.}}",
    "{{study:olam-haba|¿A dónde llega la simiente cuando da su fruto pleno? Al día en que la fractura del Edén queda sanada del todo: «YHVH será Uno y Su Nombre Uno».}}",
  ],
  ctaRef: "Genesis 3:15",
};
