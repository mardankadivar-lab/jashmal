...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 0c — בֵּית הַמִּקְדָּשׁ הַשְּׁלִישִׁי · El Tercer Templo
//  Capítulo 3 de la tríada de la Puerta — la SÍNTESIS (los dos despertares
//  fundidos). Serie "Del Enigma del Mashíaj al Ajarít HaYamim".
//
//  Hero CONCEPTUAL (sin gematría): el Tercer Templo —el lugar donde lo que sube
//  y lo que baja se vuelven un solo movimiento— y la frase-gancho del concepto
//  (Síntesis). Fuente verificada por el Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/00c-tercer-templo.md
//
...
const data: EstudioData = {
  ...
  hero: {
    ...
    serielabelFa:
      "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۰ج — دروازه · فصل ۳ (هم‌نهاد)",
    he: "בֵּית הַמִּקְדָּשׁ הַשְּׁלִישִׁי",
    titulo: "El Tercer Templo",
    tituloFa: "معبدِ سوم",
    ganchoEs:
    ...
    ganchoFa:
      "یک رستگاری بالا می‌رود، دیگری پایین می‌آید. کدام راستین است؟ هر دو، با هم — و گواهش لمس‌شدنی است: معبدِ سوم. انسان دیوارها را برمی‌افرازد؛ خدا آتش را از بالا می‌آورد. اینجا دو بیداری یکی می‌شوند و دروازه مُهر می‌خورد.",
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla I — Shemot (Éxodo) 15:17 (la clave de toda la síntesis)",
        he: "תְּבִאֵ֗מוֹ וְתִטָּעֵ֙מוֹ֙ בְּהַ֣ר נַחֲלָֽתְךָ֔ מָכ֧וֹן לְשִׁבְתְּךָ֛ פָּעַ֖לְתָּ יְהֹוָ֑ה מִקְּדָ֕שׁ אֲדֹנָ֖י כּוֹנְנ֥וּ יָדֶֽיךָ׃",
        es: "Los traerás y los plantarás en el monte de Tu heredad, el lugar para Tu morada que hiciste, oh YHVH; el Santuario, oh Señor, que Tus manos establecieron (כּוֹנְנוּ יָדֶיךָ).",
        source: "Shemot (Éxodo) 15:17",
      },
      {
        label: "Versículo-ancla II — Zejaryá (Zacarías) 6:12–13 (el Mashíaj construye)",
        he: "הִנֵּה־אִ֞ישׁ צֶ֤מַח שְׁמוֹ֙ וּמִתַּחְתָּ֣יו יִצְמָ֔ח וּבָנָ֖ה אֶת־הֵיכַ֥ל יְהֹוָֽה׃ וְה֠וּא יִבְנֶ֞ה אֶת־הֵיכַ֤ל יְהֹוָה֙ …",
        es: "He aquí un hombre, Tzémaj (Retoño) es su nombre, y de su lugar brotará, y construirá el Templo de YHVH. Y él construirá el Templo de YHVH…",
        source: "Zejaryá (Zacarías) 6:12–13",
      },
    ],
    parrafos: [
      `Quedamos con dos verdades que parecían rivales. {{study:enigma-mashiaj|La Tesis}}: la redención la subimos nosotros —obras, mérito, esfuerzo, la chispa de cada alma—. {{study:despertar-de-lo-alto|La Antítesis}}: la redención la baja Dios —Sinaí, «no por ustedes sino por Mi Nombre», la luz que no se gana—. ¿Cuál es la verdadera?`,
    ...
    parrafos: [
      {
        ...
        texto: `Que las dos verdades que parecían enfrentadas —la redención que subo y la redención que baja— nunca fueron rivales: son las dos manos de una misma obra. Yo levanto los muros; Dios trae el fuego. Si solo confío en mi esfuerzo, construyo un Templo que se romperá como los dos primeros. Si solo espero que todo baje del Cielo, no preparo ningún vaso para recibirlo. La madurez espiritual es hacer mi parte a fondo y, a la vez, saber que la permanencia no la pongo yo.`,
      },
      {
        etiqueta: "¿Qué patrones veo?",
        texto: `Veo el patrón del Sinaí en todo: Dios «empieza» bajando, yo respondo subiendo. Lo veo en na'asé venishmá —hago primero, recibo después—. Lo veo en el Shabat —trabajo seis días, recibo el séptimo—. Lo veo en el Templo —construyo el vaso, desciende la luz—. La vida espiritual entera tiene esta forma de doble manos: una mía que se esfuerza, una de Arriba que corona.`,
      },
      {
  ...
  jatima: {
    items: [
      ...
      },
      {
        ...
        texto: `Empezar hoy una obra buena cuyo final no dependa solo de ti —poner los muros con todo tu esfuerzo y confiar el fuego a lo Alto—: hacer como si todo dependiera de ti, confiar como si todo dependiera de Él. Esa es la postura del que construye el Templo verdadero.`,
      },
    ],
  },
  hemshej: [
    "{{study:ajarit-hayamim|Ahora que sabes qué es el Mashíaj, ¿qué son los “días del Mashíaj”? Gueulá, Yemot HaMashíaj, Olam HaBa y Tejiyat HaMetim no son lo mismo. Empieza el recorrido por la historia y la profecía.}}",
    "{{study:finalidad-creacion|Si el mundo se hizo roto para que lo construyéramos, ¿por qué? “El Santo deseó una morada en lo de abajo”: el Tercer Templo es esa morada terminada.}}",
    "{{study:zohar-redencion|El secreto de los dos despertares en su fuente: el Zóhar y la danza entre it'aruta diletata e it'aruta dile'eila, la Shejiná en el exilio y su retorno.}}",
    "{{study:olam-haba|¿A dónde lleva todo esto? Al día en que las dos manos terminan la obra: “YHVH será Uno y Su Nombre Uno”.}}",
  ],
  ctaRef: "Exodus 15:17",
};
