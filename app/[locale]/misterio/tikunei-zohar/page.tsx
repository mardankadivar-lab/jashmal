...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 8 — תִּקּוּנֵי הַזֹּהַר וְהַתִּקּוּן · Tikunei HaZóhar y los Procesos Finales
//  Bloque II (La Estructura Oculta). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-08-tikunei-zohar.md
//  Hero: בְּרֵאשִׁית (Bereshit) = 913 (un solo número; sin par).
...
const data: EstudioData = {
  slug: "tikunei-zohar",
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 8 — La Estructura Oculta",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۸ — ساختارِ پنهان",
    he: "תִּקּוּנֵי הַזֹּהַר",
    titulo: "Tikunei HaZóhar y los Procesos Finales",
    tituloFa: "تیکونِی زوهر و فرایندهای پایانی",
    ganchoEs:
      "Bereshit = 913. De esa sola palabra el Tikunei HaZóhar saca 70 explicaciones. El comienzo del mundo contenía, plegado, todo su final.",
    ganchoFa:
      "برئشیت = ۹۱۳. تیکونِی زوهر از همین یک واژه ۷۰ توضیح برمی‌آورد. آغازِ جهان، پایانِ آن را در خود تا کرده بود.",
    numero: { valor: "913", rom: "בְּרֵאשִׁית · Bereshit" },
  },
  targum: {
    citas: [
      {
        label: "Texto-ancla I — la palabra de la que todo cuelga (Bereshit 1:1)",
        he: "בְּרֵאשִׁ֖ית בָּרָ֣א אֱלֹהִ֑ים אֵ֥ת הַשָּׁמַ֖יִם וְאֵ֥ת הָאָֽרֶץ׃",
        es: "En el principio (Bereshit) creó Dios los cielos y la tierra.",
        source: "Bereshit (Génesis) 1:1",
      },
      {
        label: "Texto-ancla II — la apertura del Tikunei HaZóhar (Tikkunei Zohar 1a)",
        he: "רַבִּי שִׁמְעוֹן אָזַל לֵיהּ וְעָרַק לְמַדְבְּרָא דְלוּד וְאִתְגְּנִיז בְּחַד מְעַרְתָּא … וְהֲוָה אֵלִיָּהוּ זָכוּר לַטּוֹב אָתֵי לְהוֹן בְּכָל יוֹמָא תְּרֵי זִימְנֵי וְאוֹלִיף לוֹן …",
        es: "Rabí Shimón se fue y huyó al desierto de Lod, y se ocultó en una cueva, él y Rabí Elazar su hijo … y Eliahu —de bendita memoria— venía a ellos dos veces al día y les enseñaba…",
        source: "Tikkunei Zohar 1a",
      },
    ],
    parrafos: [
  ...
  pardes: {
    ...
    caja: {
      titulo: "El Tikunei HaZóhar convierte la teología del exilio en un método de reparación.",
      cuerpo:
    ...
    parrafos: [
      {
        ...
        texto: `Que reparar no es un acto enorme y lejano reservado a grandes místicos en cuevas, sino una operación que hago todo el día sin saberlo. Si el mundo está hecho de letras y mis palabras mueven letras divinas, entonces cada cosa que digo está, de algún modo, reparando o rompiendo. El tikún no es una tarea futura: es la textura de mi presente.`,
      },
      {
        etiqueta: "¿Qué patrones veo?",
        texto: `Veo que el todo cabe en la parte. Setenta sentidos en una palabra. El final del mundo plegado en su primera sílaba. Y veo el patrón de los Dos Filos en una misma palabra: Bereshit es a la vez "ya creado" y "para lo que fue creado", hecho y promesa. Mi propia vida tiene esa doble cara: lo que ya soy y aquello para lo que fui hecho. Vivir bien es llevar lo primero hacia lo segundo.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con mi alma?",
        texto: `Si Adam = el Nombre Mah = 45, entonces mi humanidad misma es una "configuración" del Nombre divino: yo soy, en pequeño, un arreglo de letras santas. Reparar el mundo y repararme a mí mismo son la misma operación vista en dos tamaños. Cuando ordeno algo torcido en mí —una palabra que enderezo, un hábito que pongo en su lugar— estoy haciendo un tikún de las letras que me componen.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con la creación?",
        texto: `La creación entera es un texto con las letras revueltas por la ruptura. La historia es el larguísimo trabajo de volver a ordenarlas hasta que la "palabra" de Dios pueda volver a leerse completa. Yo soy uno de los lectores-reparadores. Mi parte es minúscula —unas pocas letras— pero sin ella el texto no se cierra.`,
      },
    ],
  },
  maase: {
    intro: "Una acción concreta, realizable hoy, que nace de este estudio.",
    etiqueta: "Hoy, haz un tikún de una sola «letra fuera de lugar» en tu habla.",
    texto: `El Tikunei HaZóhar enseña que reparamos con palabras. Elige una sola cosa torcida en cómo hablas —una mentira pequeña que dejas pasar, una crítica que repites, un silencio que debería ser una bendición, una palabra dura que dices por costumbre— y enderézala hoy, una vez, conscientemente. Reemplaza una palabra de quiebre por una palabra de orden: una verdad donde ibas a decir una conveniencia, una bendición donde ibas a decir una queja, un nombre dicho con respeto donde ibas a decirlo con desprecio. Al hacerlo, piensa: "acabo de poner una letra divina en su lugar." No hace falta reparar el mundo entero. Reparas una letra. Hoy.`,
  },
  jatima: {
    items: [
      {
        etiqueta: "Idea principal:",
        texto: `El Tikunei HaZóhar convierte la teología del exilio en un método de reparación: el mundo está hecho de letras divinas, el desorden de esas letras es la ruptura, y el tikún es reordenarlas. Toda la obra brota de la primera palabra de la Torá, Bereshit, que despliega setenta sentidos (shivim panim).`,
      },
      {
        etiqueta: "Insight clave:",
        texto: `בְּרֵאשִׁית (Bereshit) = 913. De esa sola palabra el Tikunei extrae setenta tikunim. El comienzo del mundo contenía, plegado, todo su final: la redención no se añade desde afuera, se despliega desde el "principio".`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `El tikún de la Shejiná se hace con letras, y el agente del tikún es Israel —cada alma—: יִשְׂרָאֵל = 541, Yashar-El, "recto hacia Dios", el que endereza lo torcido. Y ya el Tikkunei Zohar 5a sella el puente al Arí: Adam = el Nombre Mah (מ"ה) = 45; el ser humano es una configuración de letras divinas.`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Hacer hoy un tikún concreto en el habla —enderezar una sola "letra fuera de lugar": una verdad en vez de una conveniencia, una bendición en vez de una queja— sabiendo que con palabras se repara el mundo, letra por letra.`,
      },
    ],
  },
  hemshej: [
    "{{study:zohar-redencion|¿Y por qué hay que reparar a la Shejiná? Porque está exiliada con nosotros. Vuelve al despertar de abajo y de arriba.}}",
    "{{study:el-ari|¿De dónde salieron las letras desordenadas? La “física” completa: Tzimtzum, Shevirá y Tikún en el sistema del Arí.}}",
    "{{study:finalidad-creacion|Si el final estaba plegado en el principio, ¿para qué se creó el mundo? “El Santo deseó una morada en lo de abajo”.}}",
  ],
  ctaRef: "Genesis 1:1",
};
