...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 2 — תַּכְלִית הַבְּרִיאָה · La Finalidad de la Creación
//  Bloque I (Historia y Profecía). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-02-finalidad-creacion.md
//  Hero: גְּאוּלָּה = אָדָם = 45 (= Nombre divino "Mah").
// ════════════════════════════════════════════════════════════════════════════

const data: EstudioData = {
  slug: "finalidad-creacion",
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 2 — Historia y Profecía",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۲ — تاریخ و نبوت",
    he: "תַּכְלִית הַבְּרִיאָה",
    titulo: "La Finalidad de la Creación",
    tituloFa: "غایتِ آفرینش",
    ganchoEs:
      "Dios no creó el mundo y luego decidió redimirlo. Lo creó porque quería una casa aquí abajo. La redención es la mudanza.",
    ganchoFa:
      "خدا جهان را نیافرید و سپس تصمیم به رستگاری‌اش بگیرد. آفرید چون خانه‌ای در پایین می‌خواست. رستگاری همان اسباب‌کشی است.",
    par: {
      a: { he: "גְּאוּלָּה", rom: "Gueulá", color: "gold" },
      b: { he: "אָדָם", rom: "Adam", color: "gold" },
      valor: "45",
    },
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla I — Bereshit (Génesis) 1:1",
        he: "בְּרֵאשִׁ֖ית בָּרָ֣א אֱלֹהִ֑ים אֵ֥ת הַשָּׁמַ֖יִם וְאֵ֥ת הָאָֽרֶץ׃",
        es: "En el principio creó Dios los cielos y la tierra.",
        source: "Bereshit (Génesis) 1:1",
      },
      {
        label: "Versículo-ancla II — Bereshit (Génesis) 2:1–3 (el sello del séptimo día)",
        he: "וַיְכֻלּ֛וּ הַשָּׁמַ֥יִם וְהָאָ֖רֶץ וְכׇל־צְבָאָֽם׃ … וַיְבָ֤רֶךְ אֱלֹהִים֙ אֶת־י֣וֹם הַשְּׁבִיעִ֔י וַיְקַדֵּ֖שׁ אֹת֑וֹ׃",
        es: "Y fueron concluidos (va'yejulú) los cielos y la tierra y toda su hueste… Y bendijo Dios el día séptimo y lo santificó.",
        source: "Bereshit (Génesis) 2:1–3",
      },
      {
        label: "El dicho de los Sabios — Midrash (formulación clásica de dirá betajtonim)",
        he: "נִתְאַוָּה הַקָּדוֹשׁ־בָּרוּךְ־הוּא לִהְיוֹת לוֹ דִּירָה בַּתַּחְתּוֹנִים",
        es: "Deseó el Santo, bendito sea, tener para Sí una morada en lo de abajo (dirá betajtonim).",
        source: "Midrash Tanchuma, Naso 16",
      },
      {
        label: "El dicho citado en el jasidut — Tania, Likutei Amarim 36",
        he: "מוּדַעַת זֹאת מַאֲמַר רַבּוֹתֵינוּ־זִכְרוֹנָם־לִבְרָכָה, שֶׁתַּכְלִית בְּרִיאַת עוֹלָם הַזֶּה הוּא – שֶׁנִּתְאַוָּה הַקָּדוֹשׁ־בָּרוּךְ־הוּא לִהְיוֹת לוֹ דִּירָה בַּתַּחְתּוֹנִים׃",
        es: "Es conocido el dicho de nuestros Sabios, de bendita memoria, de que la finalidad (tajlit) de la creación de este mundo es que el Santo, bendito sea, deseó tener para Sí una morada en lo de abajo.",
        source: "Tania, Likutei Amarim 36",
      },
    ],
    parrafos: [
    ...
    parrafos: [
      {
        ...
        texto: `Que la pregunta más grande —"¿para qué existe todo?"— tiene una respuesta sorprendentemente íntima: para que Dios tenga hogar aquí. No en un cielo lejano, sino abajo, en lo material, en lo cotidiano, donde yo vivo. Eso cambia el peso de mi vida ordinaria: lavar, comer, trabajar, conversar, no son interrupciones de lo espiritual; son los ladrillos de la morada que Dios deseó.`,
      },
      {
        etiqueta: "¿Qué patrones veo?",
        texto: `Veo que el principio y el fin se abrazan. Bereshit (el principio) y acharit hayamim (el fin) son los dos extremos de un solo arco, y lo que une los extremos es una finalidad. Veo también que lo más bajo era lo más deseado: "el final de la obra estaba en el pensamiento primero". Lo que parece más lejano de Dios —la materia— era justo lo que Él quería. El patrón es la inversión: lo último es lo primero, la caída es el principio del ascenso, recibir se convierte en dar.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con mi alma?",
        texto: `Si Gueulá (redención) y Adam (ser humano) comparten el número 45, entonces yo no soy un espectador de la redención: soy su instrumento. La morada no se construye sola ni cae del cielo terminada; se construye con mis actos de "recibir para dar". Cada vez que tomo algo del mundo y lo uso para dar en lugar de solo para mí, coloco un ladrillo. La Yejidá en mí —ese punto que ya es morada— pide ser extendida al resto de mi vida.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con la creación?",
        texto: `El mundo entero está, entonces, en obra. Todo lo que existe es material de construcción para la casa de Dios. La historia —con sus exilios y retornos— es el largo proceso de habilitar la morada. Y yo vivo dentro de la obra, no fuera de ella: cada día es un día de construcción.`,
      },
    ],
  },
  maase: {
    intro: "Una acción concreta, realizable hoy, que nace de este estudio.",
    etiqueta: "Hoy, convierte un acto material en un ladrillo de la morada.",
    texto: `Elige una acción física ordinaria que harás de todos modos —una comida, una tarea del trabajo, lavar los platos, ayudar a alguien con algo concreto— y hazla con una sola intención añadida: "recibo esto para dar, no solo para mí; aquí construyo una morada para lo divino en lo de abajo". Concretamente: en la comida, comparte un bocado o agradece en voz alta antes de empezar; en el trabajo, haz una tarea pensando en a quién sirve, no solo en lo que ganas; con los platos o la limpieza, trabaja con cuidado como quien arregla una casa que importa. El Baal Shem Tov llamó a esto avodá begashmiyut, servir a través de lo material. No busques a Dios huyendo del mundo: santifica un solo acto del mundo, hoy. Esa es, en pequeño, toda la finalidad de la creación.`,
  },
  jatima: {
    items: [
      {
        etiqueta: "Idea principal:",
        texto: `La finalidad de la creación (tajlit habriá) es que Dios tenga una morada en lo de abajo (dirá betajtonim): una casa de lo divino en el mundo físico y cotidiano. El mundo no es un fin en sí; existe por causa de un propósito (Rashi sobre Bereshit 1:1).`,
      },
      {
        etiqueta: "Insight clave:",
        texto: `Creación y redención son un solo arco. Dios no creó el mundo y luego decidió redimirlo; lo creó porque quería habitarlo. La caída de las chispas (Shevirá) no arruinó el plan — lo puso en marcha. La redención es la mudanza: el día en que el Dueño ocupa la casa.`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `גְּאוּלָּה (redención) = 45 = אָדָם (Adam) = Nombre divino "Mah" (45) (verificado). El ser humano es el instrumento de la redención: la morada se construye con manos humanas que aprenden a "recibir para dar" (Baal HaSulam). Lo más bajo era lo más deseado — "el final de la obra estaba en el pensamiento primero".`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Tomar un solo acto material ordinario y santificarlo —recibir para dar— como quien coloca un ladrillo en la morada de Dios. Avodá begashmiyut: encontrar a Dios no huyendo del mundo, sino elevándolo.`,
      },
    ],
  },
  hemshej: [
    "{{study:enigma-mashiaj|Si el mundo se creó para ser una morada, y la redención es la mudanza, ¿quién es el que hace habitable la casa? Vuelve al enigma del Mashíaj.}}",
    "{{study:el-ari|¿Por qué se rompieron los vasos y cayeron las chispas a “lo de abajo”? La estructura cósmica del Arí: Tzimtzum, Shevirá y Tikún explican el porqué de la morada.}}",
    "{{study:olam-haba|¿Cuándo queda la morada finalmente habitada? La consumación: cuando ya no quede ninguna chispa dispersa y “YHVH sea Uno y Su Nombre Uno”.}}",
  ],
  ctaRef: "Genesis 1:1",
};
