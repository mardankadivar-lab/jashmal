...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 11 — חֲסִידוּת וְהַגְּאוּלָּה הַפְּנִימִית · Jasidut y la Redención Interior
//  Bloque III (Interior y Consumación). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-11-jasidut-redencion.md
//  Hero: אַהֲבָה (Ahavá) = אֶחָד (Ejad) = 13 → 13 + 13 = 26 = יהוה.
...
const data: EstudioData = {
  ...
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 11 — Interior y Consumación",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۱۱ — درون و کمال",
    ...
    ganchoFa:
      "اَهاوا (عشق) = ۱۳ و اِچاد (یک) = ۱۳. جمع‌شان: ۲۶ = یهوه. وقتی دو عشق یکی می‌شوند، نام پدیدار می‌گردد. رستگاریِ جهان از این‌که امروز چگونه عشق می‌ورزی آغاز می‌شود.",
    par: {
      a: { he: "אַהֲבָה", rom: "Ahavá · amor · 13", color: "gold" },
      b: { he: "אֶחָד", rom: "Ejad · uno · 13", color: "gold" },
      valor: "= 26 = יהוה",
    },
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla I — Devarim (Deuteronomio) 6:4 (el Shemá)",
        he: "שְׁמַ֖ע יִשְׂרָאֵ֑ל יְהֹוָ֥ה אֱלֹהֵ֖ינוּ יְהֹוָ֥ה ׀ אֶחָֽד׃",
        es: "Escucha, Israel: YHVH es nuestro Dios, YHVH es Uno (Ejad).",
        source: "Devarim (Deuteronomio) 6:4",
      },
      {
        label: "Versículo-ancla II — Shir HaShirim (Cantar de los Cantares) 5:2",
        he: "אֲנִ֥י יְשֵׁנָ֖ה וְלִבִּ֣י עֵ֑ר ק֣וֹל ׀ דּוֹדִ֣י דוֹפֵ֗ק",
        es: "Yo duermo, pero mi corazón está despierto; la voz de mi Amado golpea (a la puerta)…",
        source: "Shir HaShirim (Cantar de los Cantares) 5:2",
      },
    ],
    parrafos: [
  ...
  jatima: {
    items: [
      ...
      },
      {
        ...
        texto: `El amor a Dios brota del conocimiento de que es Uno (Ramban). Por eso percibir la Unidad y amar son el mismo acto — y la gematría lo firma: Ahavá (13) y Ejad (13) son el mismo número.`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `אַהֲבָה (13) + אֶחָד (13) = 26 = יהוה (YHVH). Cuando el amor y la conciencia de la Unidad se vuelven una sola cosa —cuando dos se hacen uno—, el Nombre de Dios se revela en el espacio entre ellos. La redención del mundo empieza en cómo amas hoy.`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Elevar hoy una chispa en un acto material común (avodá be-gashmiut, hecho "para dar") y dar un paso de unión real con una persona — y, ante una afrenta, callar una vez en lugar de defenderse (Rebe Najman), abriendo un milímetro la puerta a la que el Amado golpea.`,
      },
    ],
  },
  hemshej: [
    "{{study:zohar-redencion|El jasidut dice “eleva la chispa hoy”. El Zóhar lo había llamado el “despertar de abajo” (it'aruta diletata) que provoca la respuesta de arriba.}}",
    "{{study:shaar-hagilgulim|Esa chispa que viniste a elevar tiene una raíz: tu tikún personal, vida tras vida.}}",
    "{{study:el-ari|¿De dónde salió toda esta doctrina de chispas e intención? La “física” luriana que el jasidut internalizó.}}",
    "{{study:olam-haba|Si la redención empieza dentro de mí, ¿cómo termina afuera, en toda la creación? La consumación final.}}",
  ],
  ctaRef: "Deuteronomy 6:4",
};
