...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 9 — הָאֲרִ״י וּמִבְנֵה הַבְּרִיאָה · El Arí y la Estructura Cósmica
//  Bloque II (La Estructura Oculta). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-09-el-ari.md
//  Hero: אָדָם (Adam) = גְּאוּלָּה (Gueulá) = 45 (= Nombre divino "Mah").
...
const data: EstudioData = {
  slug: "el-ari",
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 9 — La Estructura Oculta",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۹ — ساختارِ پنهان",
    he: "הָאֲרִ״י וּמִבְנֵה הַבְּרִיאָה",
    titulo: "El Arí y la Estructura Cósmica",
    tituloFa: "آری و ساختارِ آفرینش",
    ganchoEs:
      "Adam = 45, Gueulá = 45, y el Nombre de Dios deletreado «Mah» = 45. El ser humano, la redención y un Nombre divino comparten un número. No es casualidad: somos el instrumento del tikún.",
    ganchoFa:
      "آدام = ۴۵، گئولا = ۴۵، و نامِ خدا با هجّیِ «مَه» = ۴۵. انسان، رستگاری و یک نامِ الهی یک عدد دارند. تصادفی نیست: ما ابزارِ تیکونیم.",
    par: {
      a: { he: "אָדָם", rom: "Adam", color: "gold" },
      b: { he: "גְּאוּלָּה", rom: "Gueulá · redención", color: "gold" },
      valor: "45",
    },
  },
  targum: {
    citas: [
      {
        label: "Texto-ancla — el Tzimtzum (Etz Jaim 1:2:2)",
        he: "דַּע כִּי טֶרֶם שֶׁנֶּאֱצְלוּ הַנֶּאֱצָלִים וְנִבְרְאוּ הַנִּבְרָאִים הָיָה אוֹר עֶלְיוֹן פָּשׁוּט מְמַלֵּא כָּל הַמְּצִיאוּת … וְכַאֲשֶׁר עָלָה בִּרְצוֹנוֹ הַפָּשׁוּט לִבְרֹא הָעוֹלָמוֹת … וְהִנֵּה אָז צִמְצֵם אֶת עַצְמוֹ אֵין סוֹף בַּנְּקֻדָּה הָאֶמְצָעִית אֲשֶׁר בּוֹ …",
        es: "Sabe que antes de que se emanaran los emanados y se crearan los creados, había una Luz Suprema Simple que llenaba toda la realidad… Y cuando surgió en Su voluntad simple crear los mundos… entonces el Ein Sof (el Infinito) se contrajo a Sí mismo (tzimtzem et atzmó) en el punto central que hay en Él…",
        source: "Arizal, Etz Jaim 1:2:2 (Sefer Etz Jaim)",
      },
      {
        label: "Texto-ancla — el jalal y el Kav (Etz Jaim 1:2:4)",
        he: "וְהִנֵּה אַחַר הַצִּמְצוּם … נִשְׁאַר מָקוֹם הֶחָלָל וַאֲוִיר פָּנוּי וְרֵיקָנִי … אָז הִמְשִׁיךְ מִן אוֹר אֵין סוֹף קַו אֶחָד יָשָׁר … וְיוֹרֵד תּוֹךְ הֶחָלָל הַהוּא …",
        es: "Y he aquí que después del Tzimtzum… quedó el espacio del vacío y un aire libre y hueco (jalal)… entonces extendió, desde la Luz del Ein Sof, un rayo único y recto (kav ejad yashar)… que desciende dentro de ese vacío…",
        source: "Arizal, Etz Jaim 1:2:4",
      },
    ],
    parrafos: [
  ...
  pardes: {
    ...
    caja: {
      titulo: "Tzimtzum → Shevirá → Birur → Tikún.",
      cuerpo:
