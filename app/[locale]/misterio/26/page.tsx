            ...
            <div className="text-center">
              <span
                ...
                style={{
                  ...
                  filter: dark ? "drop-shadow(0 0 20px rgba(201,164,62,0.5))" : "drop-shadow(0 0 5px rgba(138,109,31,0.25))",
                  lineHeight: 1,
                }}
              >13</span>
            ...
            <div className="text-center">
              <span
                ...
                style={{
                  ...
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  filter: dark ? "drop-shadow(0 0 30px rgba(201,164,62,0.7))" : "drop-shadow(0 0 6px rgba(138,109,31,0.3))",
                  lineHeight: 1,
                }}
              >26</span>
              <p className="mt-1 font-cinzel text-xs uppercase tracking-widest text-gold/40">
