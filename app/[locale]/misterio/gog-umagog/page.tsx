...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 6 — גּוֹג וּמָגוֹג · Gog uMagog
//  Bloque I (Historia y Profecía). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-06-gog-umagog.md
//  Hero: אֶחָד + אֶחָד = 13 + 13 = 26 = יהוה (los dos "Uno" de Zejaryá 14:9).
// ════════════════════════════════════════════════════════════════════════════

const data: EstudioData = {
  slug: "gog-umagog",
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 6 — Historia y Profecía",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۶ — تاریخ و نبوت",
    he: "גּוֹג וּמָגוֹג",
    titulo: "Gog uMagog",
    ...
    ganchoFa:
      "تمامِ نبوتِ جنگِ پایانی به پنج واژه می‌رسد: «در آن روز خداوند یکی است و نامش یکی». جنگ، زایمانِ یگانگی است.",
    par: {
      a: { he: "אֶחָד", rom: "Ejad · Uno · 13", color: "gold" },
      b: { he: "אֶחָד", rom: "Uno · Su Nombre · 13", color: "gold" },
      valor: "= 26 = יהוה",
    },
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla I — Yejezkel 38:2 (la convocatoria de Gog)",
        he: "בֶּן־אָדָם שִׂים פָּנֶיךָ אֶל־גּוֹג אֶרֶץ הַמָּגוֹג נְשִׂיא רֹאשׁ מֶשֶׁךְ וְתֻבָל וְהִנָּבֵא עָלָיו׃",
        es: "Hijo de hombre, vuelve tu rostro hacia Gog, de la tierra de Magog, príncipe supremo de Méshej y Tuval, y profetiza contra él.",
        source: "Yejezkel (Ezequiel) 38:2",
      },
      {
        label: "Versículo-ancla II — Yejezkel 38:16 (la guerra «en el fin de los días»)",
        he: "וְעָלִיתָ עַל־עַמִּי יִשְׂרָאֵל כֶּעָנָן לְכַסּוֹת הָאָרֶץ בְּאַחֲרִית הַיָּמִים תִּהְיֶה … לְמַעַן דַּעַת הַגּוֹיִם אֹתִי בְּהִקָּדְשִׁי בְךָ לְעֵינֵיהֶם גּוֹג׃",
        es: "Y subirás contra Mi pueblo Israel como una nube que cubre la tierra; será en el fin de los días (be'ajarít hayamim)… para que las naciones Me conozcan, cuando Me santifique en ti, oh Gog, ante sus ojos.",
        source: "Yejezkel (Ezequiel) 38:16",
      },
      {
        label: "Versículo-ancla III — Yejezkel 39:7 (el propósito: el Nombre santificado)",
        he: "וְאֶת־שֵׁם קׇדְשִׁי אוֹדִיעַ בְּתוֹךְ עַמִּי יִשְׂרָאֵל וְלֹא־אַחֵל אֶת־שֵׁם־קׇדְשִׁי עוֹד וְיָדְעוּ הַגּוֹיִם כִּי־אֲנִי יְהוָה קָדוֹשׁ בְּיִשְׂרָאֵל׃",
        es: "Y daré a conocer Mi santo Nombre en medio de Mi pueblo Israel, y no dejaré profanar más Mi santo Nombre; y las naciones sabrán que Yo soy YHVH, el Santo en Israel.",
        source: "Yejezkel (Ezequiel) 39:7",
      },
      {
        label: "Versículo-ancla IV — Zejaryá 14:9 (el clímax de toda la serie)",
        he: "וְהָיָה יְהוָה לְמֶלֶךְ עַל־כׇּל־הָאָרֶץ בַּיּוֹם הַהוּא יִהְיֶה יְהוָה אֶחָד וּשְׁמוֹ אֶחָד׃",
        es: "Y YHVH será Rey sobre toda la tierra; en aquel día YHVH será Uno y Su Nombre Uno.",
        source: "Zejaryá (Zacarías) 14:9",
      },
    ],
    parrafos: [
  ...
  mefarshim: {
    parrafos: [
      ...
      },
      {
        ...
        texto: `Atento al lenguaje, Malbim subraya el propósito declarado y repetido de la guerra: "lemaan daat hagoyim otí", "para que las naciones Me conozcan" (38:16), y "vidú hagoyim ki aní YHVH", "y las naciones sabrán que Yo soy YHVH" (39:7). Malbim insiste: la finalidad de Gog uMagog no es la aniquilación de las naciones, sino su conocimiento. La palabra clave del relato no es guerra sino daat, "conocer". La guerra termina precisamente cuando el conocimiento se cumple — y por eso desemboca en Zejaryá 14:9, donde el Nombre es reconocido por todos.`,
      },
      {
    ...
    parrafos: [
      {
        ...
        texto: `Que la guerra más temida de la profecía no tiene como meta la muerte de nadie, sino el conocimiento de todos. Tres veces repite Yejezkel: para que conozcan. Me enseña que el verdadero enemigo nunca fue un pueblo del norte: fue la ceguera — la incapacidad de ver que todo es Uno. Y la ceguera no se mata: se disuelve cuando llega la luz.`,
      },
      {
        etiqueta: "¿Qué patrones veo?",
        texto: `Veo que el fuego del fin refina, no destruye ("los refinaré como se refina la plata", Zejaryá 13:9). Veo que el mal, llevado a su extremo y mostrado sin máscara, se revela vacío y se agota solo. Y veo el patrón más grande de toda la serie: el ruido más fuerte —una guerra cósmica— desemboca en el silencio más hondo —cinco palabras de unidad—. Como el jashmal que da nombre a este proyecto: jash (silencio) y mal (habla). Primero el estruendo, después la palabra serena de la Unidad.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con mi alma?",
        texto: `Hay un Gog en mí. No en el norte del mapa, sino en el centro del pecho: la parte que quiere recibir todo para sí y tapar la luz "como una nube". El Baal Shem Tov me enseña que no debo odiar esa fuerza ni intentar matarla — debo refinarla, pasar su fuego por el crisol y convertirlo en fuego de servicio. Mi guerra interior no se gana destruyendo mi deseo, sino transmutándolo.`,
      },
      {
        etiqueta: "¿Cómo se relaciona con la creación?",
        texto: `Que Gog uMagog valga 70, el número de las naciones, me dice que esta no es la historia de un pueblo contra otro: es la historia de toda la humanidad llegando, por el camino más áspero, al mismo conocimiento. La creación entera —las setenta naciones, los dos "Uno" que suman el Nombre— está destinada a reunirse. Incluso la última guerra es, en el fondo, un parto: el dolor por el que la Unidad viene al mundo.`,
      },
    ],
  },
  maase: {
    intro: "Una acción concreta, realizable hoy, que nace de este estudio.",
    etiqueta: "Hoy, refina tu propio «Gog» en vez de combatirlo.",
    texto: `Identifica una sola fuerza interior tuya que normalmente tratas como enemiga —una ira, una ambición, un deseo intenso, una impaciencia— y en lugar de pelear contra ella o avergonzarte de ella, hazle hoy una sola cosa: pásala por el crisol, encáuzala hacia el dar. ¿Tienes ira? Úsala hoy para defender a alguien que no puede defenderse. ¿Ambición? Ponla hoy al servicio de algo que beneficie a otro. ¿Deseo intenso? Dirígelo hoy hacia un acto de bondad concreto. Al hacerlo, di en tu interior: "no te destruyo, te refino — convierto tu fuego en luz". Recuerda que la meta de la guerra final no es matar, es conocer; y que el fuego del fin no aniquila la plata, la purifica. Refina hoy una sola chispa de tu fuego. Esa es tu Gog uMagog de hoy — y termina, como la profecía, en un poco más de Unidad.`,
  },
  jatima: {
    items: [
      {
        etiqueta: "Idea principal:",
        texto: `Gog uMagog (Yejezkel 38–39; Zejaryá 12–14) no es destrucción por destrucción, sino el último filtrado de las kelipot antes del tikún — el residuo del mal, ya sin chispa que rescatar, que al manifestarse sin máscara se revela vacío y se consume. La guerra es el parto de la Unidad.`,
      },
      {
        etiqueta: "Insight clave:",
        texto: `El verbo central del relato no es matar sino conocer (daat). Tres veces lo declara Yejezkel: "para que las naciones Me conozcan… las naciones sabrán que Yo soy YHVH" (38:16; 39:7). El enemigo verdadero es la ceguera, y la ceguera no se mata: se disuelve con la luz. Por eso el fuego del fin refina la plata (Zejaryá 13:9), no la destruye.`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `Toda la profecía desemboca en cinco palabras —"YHVH será Uno y Su Nombre Uno" (Zejaryá 14:9)— y la gematría sella la serie: אֶחָד = 13, y los dos "Uno" del versículo suman 13 + 13 = 26 = יהוה. Los dos "Uno" del clímax no son dos: sumados son el Nombre. Y גּוֹג וּמָגוֹג = 70, las setenta naciones: la última guerra es la de toda la humanidad llegando al mismo conocimiento.`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Refinar hoy una sola fuerza interior que tratamos como enemiga —ira, ambición, deseo— encauzándola hacia el dar, en vez de combatirla; recordando que la meta no es destruir, sino conocer, y que el fuego del fin purifica, no aniquila.`,
      },
    ],
  },
  hemshej: [
    "{{study:daniel-apocaliptica|¿De qué “tiempo de angustia” sale esta guerra? Del cómputo sellado de Daniel: las cuatro bestias y el fin de los imperios.}}",
    "{{study:mashiaj-jazal|¿Quién cae en esta guerra? Mashíaj ben Yosef, el recolector que entrega su vida en el último filtrado. Vuelve a los dos Mashíaj del Talmud.}}",
    "{{study:zohar-redencion|Si la guerra disuelve la última kelipá “desde abajo”, ¿qué responde “desde arriba”? El despertar de arriba y la Shejiná en el exilio: el Zóhar y la redención.}}",
    "{{study:olam-haba|¿Hacia dónde desemboca todo? Hacia la unión final: “YHVH Uno y Su Nombre Uno”. Olam HaBa y la consumación.}}",
  ],
  ctaRef: "Zechariah 14:9",
};
