...
// ════════════════════════════════════════════════════════════════════════════
//  ESTUDIO 10 — שַׁעַר הַגִּלְגּוּלִים · Shaar HaGilgulim y la Rectificación de las Almas
//  Bloque II (La Estructura Oculta). Contenido del Sofer:
//  Desktop/Contenido/Mashiaj-AjaritHaYamim/study-10-shaar-hagilgulim.md
//  Hero: יְחִידָה (Yejidá) = הֶבֶל (Hével) = 37.
...
const data: EstudioData = {
  ...
  hero: {
    serielabel: "Serie «Del Enigma del Mashíaj al Ajarít HaYamim» · Estudio 10 — La Estructura Oculta",
    serielabelFa: "سری «از معمای ماشیح تا آخریتِ روزها» · مطالعهٔ ۱۰ — ساختارِ پنهان",
    ...
    ganchoFa:
      "یِحیدا = هِوِل = ۳۷. بلندترین نقطهٔ جانِ تو، یادِ نخستین فرزندی را که مُرد در خود دارد. هر بار که خود را اصلاح می‌کنی، چیزی از عدن را ترمیم می‌کنی.",
    par: {
      a: { he: "יְחִידָה", rom: "Yejidá · el alma única", color: "gold" },
      b: { he: "הֶבֶל", rom: "Hével · Abel", color: "gold" },
      valor: "37",
    },
  },
  targum: {
    citas: [
      {
        label: "Versículo-ancla — Bereshit (Génesis) 2:7",
        he: "וַיִּ֩יצֶר֩ יְהֹוָ֨ה אֱלֹהִ֜ים אֶת־הָֽאָדָ֗ם עָפָר֙ מִן־הָ֣אֲדָמָ֔ה וַיִּפַּ֥ח בְּאַפָּ֖יו נִשְׁמַ֣ת חַיִּ֑ים וַיְהִ֥י הָֽאָדָ֖ם לְנֶ֥פֶשׁ חַיָּֽה׃",
        es: "Y formó YHVH Elohim al hombre (ha-adam), polvo del suelo, y sopló en sus narices aliento de vida (nishmat jayim), y fue el hombre como alma viviente (néfesh jayá).",
        source: "Bereshit (Génesis) 2:7",
      },
    ],
    parrafos: [
    ...
    items: [
      {
        ...
        texto: `El alma única de Adam HaRishón se fragmentó con el pecado y sus chispas se dispersaron; el gilgul (la reencarnación) es el mecanismo por el cual esas chispas se rectifican y recogen a lo largo de las generaciones. La rectificación de las almas es el rostro personal e íntimo del mismo birur cósmico que el Arí describe a escala del universo (Estudio 9).`,
      },
      {
        etiqueta: "Insight clave:",
        texto: `El doble yud de vaytzer (Bereshit 2:7, según Rashi) inscribe en la palabra "formó" dos formaciones: para este mundo y para la resurrección. El alma fue diseñada, desde el primer versículo, para más de una vida; reencarnar no es un castigo sino una nueva oportunidad de completar lo pendiente.`,
      },
      {
        etiqueta: "Insight espiritual:",
        texto: `יְחִידָה (Yejidá) = 37 = הֶבֶל (Hével) = 37. El nivel más alto del alma —el que nunca se separó de Dios— carga la memoria del primer hijo que murió. Lo más divino de ti es el guardián de la primera herida del mundo, y por eso mismo el agente de su cura. Cada tikún personal repara algo del Edén.`,
      },
      {
        etiqueta: "Aplicación práctica:",
        texto: `Tomar hoy una midá recurrente y, en vez de combatirla como un defecto, tratarla como una chispa que se vino a elevar — y elevarla una sola vez, conscientemente, sabiendo que es el alma saldando una cuenta antigua.`,
      },
    ],
  },
  hemshej: [
    "{{study:el-ari|Si el gilgul recoge las chispas de un alma, ¿de dónde salió la ruptura? La “física” cósmica: Tzimtzum, Shevirá, Birur y Tikún en el sistema del Arí.}}",
    "{{study:jasidut-redencion|Si lo más hondo de mí nunca cayó, ¿cómo lo revelo en lo cotidiano? La redención que empieza adentro.}}",
    "{{study:exilio-redencion|El exilio de los cuerpos en la geografía tiene un gemelo: el exilio de las chispas en el tiempo. Almas en el galut.}}",
    "{{study:olam-haba|¿A dónde llegan todas las chispas cuando vuelven? La resurrección reúne, por fin, cuerpo y alma.}}",
  ],
  ctaRef: "Genesis 2:7",
};
