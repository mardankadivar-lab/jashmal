  ...
  return (
    <div className="relative min-h-screen overflow-hidden" dir="ltr">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-6 py-12">
        ...
        {/* banner hacia Módulo 6 */}
        {m5AllDone && (
          <div className="mt-8 rounded-2xl border border-gold/25 bg-gold/[0.04] px-6 py-5 text-center">
            <p className="font-cinzel text-[10px] uppercase tracking-[0.25em] text-gold/55">
              Módulo 6 →{" "}
              <span className="hebrew text-gold/80">תּוֹרָה שֶׁבְּעַל פֶּה</span>
            </p>
            <p className="mt-1 text-sm text-parchment/70">La Torá oral</p>
            <div className="mt-4">
              <Link
